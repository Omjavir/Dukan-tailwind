function Sidebar() {
  return (
    <div className="text-white">
      ...
      <aside
        id="default-sidebar"
        className="fixed text-white-200 top-0 left-0 z-40 w-56 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-blue-800 flex flex-col gap-6">
          <div>
            <div className="flex items-center gap-3">
              <div>
                <div>
                  <p className="h-3.8 leading-5.5 text-white-500 font-inter font-medium">
                    Om Javir
                  </p>
                  <p className="leading-4 h-4 underline font-normal">
                    Visit store
                  </p>
                </div>
              </div>
          ...
          <div>
            <ul className="space-y-2 font-medium">
              <li className="hover:bg-blue-900"></li>
              <li className="hover:bg-blue-900">
                <a
                  href="#"
                  className="flex items-center p-2   rounded-lg dark:text-white  hover:bg-white-100 hover:text-white-500 group"
                >
                  <svg
                    width="20"
                    height="20"
          ...
          <div className="mt-auto bg-blue-900">
            <a
              href="#"
              className="flex items-center p-2 gap-2.5  rounded-lg bg-grey-100  hover:bg-white-100 hover:text-white-500 group"
            >
